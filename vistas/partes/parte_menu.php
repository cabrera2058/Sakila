...
<nav class="navbar navbar-expand-lg bg-dark">
    ...
    <div class="container">
        ...
        <a class="navbar-brand blanco" style="font-size: 25px; text-decoration: none" href="index.php"><img  class="rounded-circle bg-white" src="static/images/a.png" alt="Nombre de la pagina"   width="75px "  >  sakila</a>
